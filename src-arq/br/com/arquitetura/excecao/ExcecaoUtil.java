 ...
 * <li>Escreve o erro no log</li> <li>Direciona para tela de erro <b>error.jsf</b></li>
 * 
 * @author Igor Galvao
 */
public class ExcecaoUtil {
	...
	public static void tratarExcecao(Exception e) {
		...
		try {
			if (FacesContext.getCurrentInstance() != null && FacesContext.getCurrentInstance().getExternalContext() != null) {
				...
				FacesContext.getCurrentInstance().getExternalContext().redirect(path + "/pages/error/error.jsf");
	...
	private void enviarEmail(String error) {
		...
		Thread thread = new ThreadEnviarEmail(mailSender, ConstantesARQ.ASSUNTO_EMAIL_ERRO, error, ConstantesARQ.EMAIL_ERRO,
				ConstantesARQ.EMAIL_ERRO_CC, Constantes.EMAIL_SISTEMA, true);
		thread.start();
	}
	...
	private static String printStackTraceToString(Exception e, String path, String pagina, String ip) {
		...
		return "<font color='red'>IP: " + ip + "<br>Pagina:  " + pagina + "<br>SISTEMA: " + path + "<br/>Data e Hora: "
				+ DateUtil.getDataHora(new Date(), "dd/MM/yyyy HH:mm:ss") + "</font><br/><br/>" + "------<br/>" + sw.toString()
				+ "------<br/>";
	}
}
