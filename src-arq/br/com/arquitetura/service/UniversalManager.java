...
public interface UniversalManager extends Serializable {
	...
	/**
	 * Metodo responsavel por verifica se já existe registro cadastrado
	 * 
	 * @param clazz
	 * @param campo
	 * @param id
	 * @return true - Registro unico
	 * @return false - Já existe registro cadastrado
	 */
	public boolean uniqueValue(Class clazz, String campo, String valueCampo, Serializable id) throws Exception;
}