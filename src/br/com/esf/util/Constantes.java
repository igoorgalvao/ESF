...
public class Constantes extends ConstantesARQ {
	...
	public static String MENSAGEM_AUTOMATICA_EMAIL = getString("mensagem_automatica");
	public static String TITULO_EMAIL_CADASTRO = getString("titulo_mensagem_email_cadastro");
}
